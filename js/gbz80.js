const gameboy_hardware_constants = {
    ...
    "_OAMRAM": {
        ...
        flags: {
            "OAMF_PRI": { value: "%10000000", description: "Flag to set on OAM attribute byte to make the background colors 1-3 to have priority over the sprite."},
            "OAMF_YFLIP": { value: "%01000000", description: "Flag to set on OAM attribute byte to make the sprite flip in the Y direction"},
            "OAMF_XFLIP": { value: "%00100000", description: "Flag to set on OAM attribute byte to make the sprite flip in the X direction"},
            "OAMF_PAL0": { value: "%00000000", description: "Flag to set on OAM attribute byte to make the sprite use OBP0 in DMG (non-color) mode."},
            "OAMF_PAL1": { value: "%00010000", description: "Flag to set on OAM attribute byte to make the sprite use OBP1 in DMG (non-color) mode."},
            "OAMF_BANK0": { value: "%00000000", description: "Flag to set on OAM attribute byte to use a sprite graphics from VRAM Bank 0 in GBC mode."},
            "OAMF_BANK1": { value: "%00001000", description: "Flag to set on OAM attribute byte to use a sprite graphics from VRAM Bank 1 in GBC mode."},
            "OAMF_PALMASK": { value: "%00000111", description: "Mask of the color sprite palette index in the OAM attribute byte. In GBC mode."},

            "OAMB_PRI": { value: "7", description: "Bit number to set on OAM attribute byte to make the background colors 1-3 to have priority over the sprite."},
            "OAMB_YFLIP": { value: "6", description: "Bit number to set on OAM attribute byte to make the sprite flip in the Y direction."},
            "OAMB_XFLIP": { value: "5", description: "Bit number to set on OAM attribute byte to make the sprite flip in the X direction."},
            "OAMB_PAL1": { value: "4", description: "Bit number to set on OAM attribute byte to make the sprite use OBP1 in DMG (non-color) mode."},
            "OAMB_BANK1": { value: "3", description: "Bit number to set on OAM attribute byte to use a sprite graphics from VRAM Bank 1 in GBC mode."},
        }
    },
    "_AUD3WAVERAM": {
    ...
    "rP1": {
        ...
        value: "$FF00",
        flags: {
            "P1F_5": { value: "%00100000", description: "P15 out port, set to 0 to get buttons"},
            "P1F_4": { value: "%00010000", description: "P14 out port, set to 0 to get dpad"},
            ...
            "P1F_GET_DPAD": { description: "Value to load in rP1 to enable the reading of the DPad inputs."},
            "P1F_GET_BTN": { description: "Value to load in rP1 to enable the reading of the A/B/Start/Select inputs."},
            "P1F_GET_NONE": { description: "Value to load in rP1 to disable the reading of input buttons."},
        }
    },
    ...
    "rLCDC": {
        ...
        flags: {
            ...
            "LCDCF_WIN9800": { value: "%00000000", description: "Window Tile Map Display Select"},
            "LCDCF_WIN9C00": { value: "%01000000", description: "Window Tile Map Display Select"},
            "LCDCF_WINOFF": { value: "%00000000", description: "Window Display"},
            "LCDCF_WINON": { value: "%00100000", description: "Window Display"},
            "LCDCF_BG8800": { value: "%00000000", description: "BG & Window Tile Data Select"},
            "LCDCF_BG8000": { value: "%00010000", description: "BG & Window Tile Data Select"},
            "LCDCF_BG9800": { value: "%00000000", description: "BG Tile Map Display Select"},
            "LCDCF_BG9C00": { value: "%00001000", description: "BG Tile Map Display Select"},
    ...
    "rSTAT": {
        ...
        value: "$FF41",
        flags: {
            "STATF_LYC": { value: "%01000000", description: "LYC=LY Coincidence interrupt enabled (writable)"},
            "STATF_MODE10": { value: "%00100000", description: "Mode 10 OAM STAT interrupt enabled (writable)"},
            "STATF_MODE01": { value: "%00010000", description: "Mode 01 V-Blank STAT interrupt enabled (writable)"},
            "STATF_MODE00": { value: "%00001000", description: "Mode 00 H-Blank STAT interrupt enabled (writable)"},
            ...
            "STATF_OAM": { value: "%00000010", description: "OAM-RAM is used by system"},
            "STATF_LCD": { value: "%00000011", description: "Both OAM and VRAM used by system"},
            "STATF_BUSY": { value: "%00000010", description: "When set, VRAM access is unsafe"},
        }
    },
    ...
    "rLYC": {
        description: "LY Compare (R/W)<br>When LY==LYC, STATF_LYCF will be set in STAT",
        value: "$FF45"
    },
    ...
    "rBGP": {
        description: "BG Palette Data (W)<br>Bit 7-6 - Intensity for %11<br>Bit 5-4 - Intensity for %10<br>Bit 3-2 - Intensity for %01<br>Bit 1-0 - Intensity for %00",
        value: "$FF47"
    },
    
    "rOBP0": {
        description: "Object Palette 0 Data (W)<br>Bit 7-6 - Intensity for %11<br>Bit 5-4 - Intensity for %10<br>Bit 3-2 - Intensity for %01<br>Bit 1-0 - Ignored, %00 is transparent",
        value: "$FF48"
    },
    "rOBP1": {
        description: "Object Palette 1 Data (W)<br>Bit 7-6 - Intensity for %11<br>Bit 5-4 - Intensity for %10<br>Bit 3-2 - Intensity for %01<br>Bit 1-0 - Ignored, %00 is transparent",
        value: "$FF49"
    },
    ...
    "rKEY1": {
        description: "Select CPU Speed (R/W) GBC Only!<br>Bit 7 contains current speed: 1 is double speed.<br>Write bit 0 to 1 and execute a STOP instruction to switch speed.",
        value: "$FF4D"
    },
    ...
    "rIE": {
        ...
        value: "$FFFF",
        flags: {
            "IEF_HILO": { value: "%00010000", description: "Transition from High to Low of Pin number P10-P13"},
            "IEF_SERIAL": { value: "%00001000", description: "Serial I/O transfer end"},
    ...
    //AUDVOL/NR50 ($FF24)
    "rNR50": {
        description: "Channel control / ON-OFF / Volume (R/W)<br>Bit 7   - Vin->SO2 ON/OFF (Vin??)<br>Bit 6-4 - SO2 output level (volume) (# 0-7)<br>Bit 3   - Vin->SO1 ON/OFF (Vin??)<br>Bit 2-0 - SO1 output level (volume) (# 0-7)",
        value: "$FF24",
        alias: "rAUDVOL",
        /* flags: {
    ...
    //AUDENA/NR52 ($FF26)
    "rNR52": {
        description: "Sound on/off (R/W)<br>Bit 7   - All sound on/off (sets all audio regs to 0!)<br>Bit 3   - Sound 4 ON flag (read only)<br>Bit 2   - Sound 3 ON flag (read only)<br>Bit 1   - Sound 2 ON flag (read only)<br>Bit 0   - Sound 1 ON flag (read only)",
        value: "$FF26",
        alias: "rAUDENA",
        flags: {
    ...
    //AUD1SWEEP/NR10 ($FF10)
    "rNR10": {
        description: "Sweep register (R/W)<br>Bit 6-4 - Sweep Time<br>Bit 3   - Sweep Increase/Decrease<br>&nbsp; 0: Addition<br>&nbsp; 1: Subtraction<br>Bit 2-0 - Number of sweep shift (# 0-7)<br>Sweep Time: (n*7.8ms)",
        value: "$FF10",
        alias: "rAUD1SWEEP",
        flags: {
    ...
    //AUD1LEN/NR11 ($FF11)
    "rNR11": {
        description: "Sound length/Wave pattern duty (R/W)<br>Bit 7-6 - Wave Pattern Duty (00:12.5% 01:25% 10:50% 11:75%)<br>Bit 5-0 - Sound length data (# 0-63)",
        value: "$FF11",
        alias: "rAUD1LEN",
        flags: {
...
Bit 2-0 - Number of envelope sweep (# 0-7)`,
    ...
    //Cart related
    "CART_COMPATIBLE_DMG": { description: "Store at $0143 to indicate DMG cartridge. ($00)"},
    "CART_COMPATIBLE_DMG_GBC": { description: "Store at $0143 to indicate DMG and GBC compatible cartridge. ($80)"},
    "CART_COMPATIBLE_GBC": { description: "Store at $0143 to indicate GBC compatible cartridge. ($C0)"},
    ...
    "CART_ROM_MBC3_RAM_BAT_RTC": { description: "Store at $0147 to cart type. ($10)"},
    ...
    "CART_ROM_MBC5_RAM_RUMBLE": { description: "Store at $0147 to cart type. ($1D)"},
    "CART_ROM_MBC5_RAM_BAT_RUMBLE": { description: "Store at $0147 to cart type. ($1E)"},
    "CART_ROM_MBC7_RAM_BAT_GYRO": { description: "Store at $0147 to cart type. ($22)"},
    "CART_ROM_POCKET_CAMERA": { description: "Store at $0147 to cart type. ($FC)"},

    "CART_ROM_256K": { description: "Store at $0148 to indicate the number of ROM banks: 2 banks"},
    "CART_ROM_512K": { description: "Store at $0148 to indicate the number of ROM banks: 4 banks"},
    "CART_ROM_1M": { description: "Store at $0148 to indicate the number of ROM banks: 8 banks"},
    "CART_ROM_2M": { description: "Store at $0148 to indicate the number of ROM banks: 16 banks"},
    "CART_ROM_4M": { description: "Store at $0148 to indicate the number of ROM banks: 32 banks"},
    "CART_ROM_8M": { description: "Store at $0148 to indicate the number of ROM banks: 64 banks"},
    "CART_ROM_16M": { description: "Store at $0148 to indicate the number of ROM banks: 128 banks"},
    "CART_ROM_32M": { description: "Store at $0148 to indicate the number of ROM banks: 256 banks"},
    "CART_ROM_64M": { description: "Store at $0148 to indicate the number of ROM banks: 512 banks"},

    "CART_RAM_NONE": { description: "Store at $0149 to indicate the amount of SRAM: No SRAM"},
    "CART_RAM_16K": { description: "Store at $0149 to indicate the amount of SRAM: 2 KiloByte, 1 bank"},
    "CART_RAM_64K": { description: "Store at $0149 to indicate the amount of SRAM: 8 KiloByte, 1 bank"},
    "CART_RAM_256K": { description: "Store at $0149 to indicate the amount of SRAM: 32 KiloByte, 4 banks"},
    "CART_RAM_1M": { description: "Store at $0149 to indicate the amount of SRAM: 128 KiloByte, 16 banks"},

    "CART_RAM_ENABLE": { description: "Write this value to $0000 to enable SRAM. ($0A)"},
    "CART_RAM_DISABLE": { description: "Write this value to $0000 to disable SRAM. ($00)"},
...
for(var key in gameboy_hardware_constants)
{
    ...
    {
        gameboy_hardware_constants[gameboy_hardware_constants[key].alias] = Object.assign({}, gameboy_hardware_constants[key]);
