const gameboy_hardware_constants = {
  ...
  _OAMRAM: {
    ...
    flags: {
      ...
      OAMF_YFLIP: {
        value: '%01000000',
        description: 'Flag to set on OAM attribute byte to make the sprite flip in the Y direction',
      },
      OAMF_XFLIP: {
        value: '%00100000',
        description: 'Flag to set on OAM attribute byte to make the sprite flip in the X direction',
      },
      OAMF_PAL0: {
        value: '%00000000',
        description:
  ...
  rP1: {
    ...
    flags: {
      ...
      P1F_GET_DPAD: {
        description: 'Value to load in rP1 to enable the reading of the DPad inputs.',
      },
      P1F_GET_BTN: {
        description: 'Value to load in rP1 to enable the reading of the A/B/Start/Select inputs.',
      },
      P1F_GET_NONE: {
        description: 'Value to load in rP1 to disable the reading of input buttons.',
      },
    },
  },
...
Bit 2-0 - Number of envelope sweep (# 0-7)`,
  ...
  CART_COMPATIBLE_DMG_GBC: {
    description: 'Store at $0143 to indicate DMG and GBC compatible cartridge. ($80)',
  },
  CART_COMPATIBLE_GBC: {
  ...
  CART_ROM_16M: {
    description: 'Store at $0148 to indicate the number of ROM banks: 128 banks',
  },
  CART_ROM_32M: {
    description: 'Store at $0148 to indicate the number of ROM banks: 256 banks',
  },
  CART_ROM_64M: {
    description: 'Store at $0148 to indicate the number of ROM banks: 512 banks',
  },
  ...
  CART_RAM_16K: {
    description: 'Store at $0149 to indicate the amount of SRAM: 2 KiloByte, 1 bank',
  },
  CART_RAM_64K: {
    description: 'Store at $0149 to indicate the amount of SRAM: 8 KiloByte, 1 bank',
  },
  CART_RAM_256K: {
    description: 'Store at $0149 to indicate the amount of SRAM: 32 KiloByte, 4 banks',
  },
  CART_RAM_1M: {
    description: 'Store at $0149 to indicate the amount of SRAM: 128 KiloByte, 16 banks',
  },
